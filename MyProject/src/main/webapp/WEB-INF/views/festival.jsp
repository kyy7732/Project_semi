  ...
  <%@ include file="./include/header.jsp" %>
    ...
    <body>
      ...
      <script>
        ...
        document.querySelector('#btn').addEventListener('math.random', function (e) {
          console.log('random ftv!');
        });
                ...
                geocoder.addressSearch(
                  ...
                  function (result, status) {
                    ...
                    if (status === kakao.maps.services.Status.OK) {
                      ...
                      // displayMarker(data[i]); // 결과값으로 받은 위치를 마커로 표시하는 함수
                      ...
                      //   content.innerHTML = data.ftvName;
