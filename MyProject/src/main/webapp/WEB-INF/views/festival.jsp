        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <label for="roadAddr" class="col-form-label">도로명 주소:</label>
              <div class="mb-3" id="roadAddr">
                주소
              </div>
              ...
              <label for="url" class="col-form-label">홈페이지:</label>
              <div class="mb-3" id="urlBox">
                <a id="url" href="##" target="_blank"><span id="aContent"></span></a>
              </div>
            </div>
            <div class="link-inner">
          ...
          <div class="ressk">
            <s_rp_input_form>
              <div class='textarea'>
                <textarea id="replytext" name="" cols="" rows="4" placeholder="여러분의 소중한 댓글을 입력해주세요."></textarea>
                <div class="submit">
